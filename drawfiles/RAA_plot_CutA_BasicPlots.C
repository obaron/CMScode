...
// non-centrality based
  ...
  TCanvas  * cpteta_noCut[nbins_cent];
  TCanvas  * cpteta_CutA[nbins_cent];
...
cout<<"histograms declared"<<endl;	
  ...
  for(int i = 0;i<nbins_cent;++i){
	...
	hpbpb_matrix_HLT[i] = new TH2F(Form("hpbpb_matrix_HLT_R%d_%s_cent%d",radius,etaWidth,i),Form("Matrix refpt jtpt from trigger addition R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000,1000,0,1000); //<- MATRIX HLT
...
// new plots
   ...
   hData_Jet55_noCut_JetpTeta[i] = new TH2F(Form("hData_Jet55_noCut_pTeta_R%d_cent%d",radius,i),Form("Data Jet55 no cuts pT-eta R%d %2.0f - %2.0f cent",radius,5*(float)boundaries_cent[i],5*(float)boundaries_cent[i+1]),100,-2.5,2.5,1000,0,1000);   
   hData_Jet55_CutA_JetpTeta[i] = new TH2F(Form("hData_Jet55_CutA_pTeta_R%d_cent%d",radius,i),Form("Data Jet55 CutA pT-eta R%d %2.0f - %2.0f cent",radius,5*(float)boundaries_cent[i],5*(float)boundaries_cent[i+1]),100,-2.5,2.5,1000,0,1000);
   hData_Jet65_noCut_JetpTeta[i] = new TH2F(Form("hData_Jet65_noCut_pTeta_R%d_cent%d",radius,i),Form("Data Jet65 no cuts pT-eta R%d %2.0f - %2.0f cent",radius,5*(float)boundaries_cent[i],5*(float)boundaries_cent[i+1]),100,-2.5,2.5,1000,0,1000);   
   hData_Jet65_CutA_JetpTeta[i] = new TH2F(Form("hData_Jet65_CutA_pTeta_R%d_cent%d",radius,i),Form("Data Jet65 CutA pT-eta R%d %2.0f - %2.0f cent",radius,5*(float)boundaries_cent[i],5*(float)boundaries_cent[i+1]),100,-2.5,2.5,1000,0,1000);
   hData_Jet80_noCut_JetpTeta[i] = new TH2F(Form("hData_Jet80_noCut_pTeta_R%d_cent%d",radius,i),Form("Data Jet80 no cuts pT-eta R%d %2.0f - %2.0f cent",radius,5*(float)boundaries_cent[i],5*(float)boundaries_cent[i+1]),100,-2.5,2.5,1000,0,1000);   
   hData_Jet80_CutA_JetpTeta[i] = new TH2F(Form("hData_Jet80_CutA_pTeta_R%d_cent%d",radius,i),Form("Data Jet80 CutA pT-eta R%d %2.0f - %2.0f cent",radius,5*(float)boundaries_cent[i],5*(float)boundaries_cent[i+1]),100,-2.5,2.5,1000,0,1000);
   ...
   cpteta_noCut[i] = new TCanvas(Form("hData_Jet55_noCut_pTeta_R%d_cent%d",radius,i),Form("hData_Jet55_noCut_pTeta_R%d_cent%d",radius,i),1500,600);
   cpteta_CutA[i] = new TCanvas(Form("hData_Jet55_CutA_pTeta_R%d_cent%d",radius,i),Form("hData_Jet55_CutA_pTeta_R%d_cent%d",radius,i),1500,600);
 ...
 fout.cd();
  ...
  for(int i = 0; i<nbins_cent;++i){ //Write centrality histograms
	...
	cmatrix_HTL[i]->SaveAs(Form("hpbpb_matrix_HLT_R%d_n20_eta_p20_cent%d.pdf",radius,i),"RECREATE");
