...
void RAA_plot_yetkinCutEfficiency_pp(Int_t radius = 4){
  ...
  static const double trigarray[3] = {40,60,80};
  ...
  TH1F * hpp_Data_eta_Jet80_noCut = new TH1F("hpp_Data_eta_Jet80_noCut","",50,-2.5,2.5);
  TH1F * hpp_Data_eta_Jet60_noCut = new TH1F("hpp_Data_eta_Jet60_noCut","",50,-2.5,2.5);
  TH1F * hpp_Data_eta_Jet40_noCut = new TH1F("hpp_Data_eta_Jet40_noCut","",50,-2.5,2.5);

  TH1F * hpp_Data_eta_Jet80_CutA = new TH1F("hpp_Data_eta_Jet80_CutA","",50,-2.5,2.5);
  TH1F * hpp_Data_eta_Jet60_CutA = new TH1F("hpp_Data_eta_Jet60_CutA","",50,-2.5,2.5);
  TH1F * hpp_Data_eta_Jet40_CutA = new TH1F("hpp_Data_eta_Jet40_CutA","",50,-2.5,2.5);
  
  TH1F * hpp_MC_eta_Jet80_noCut = new TH1F("hpp_MC_eta_Jet80_noCut","",50,-2.5,2.5);
  TH1F * hpp_MC_eta_Jet60_noCut = new TH1F("hpp_MC_eta_Jet60_noCut","",50,-2.5,2.5);
  TH1F * hpp_MC_eta_Jet40_noCut = new TH1F("hpp_MC_eta_Jet40_noCut","",50,-2.5,2.5);

  TH1F * hpp_MC_eta_Jet80_CutA = new TH1F("hpp_MC_eta_Jet80_CutA","",50,-2.5,2.5);
  TH1F * hpp_MC_eta_Jet60_CutA = new TH1F("hpp_MC_eta_Jet60_CutA","",50,-2.5,2.5);
  TH1F * hpp_MC_eta_Jet40_CutA = new TH1F("hpp_MC_eta_Jet40_CutA","",50,-2.5,2.5);  
  
  //phi
  
  TH1F * hpp_Data_phi_Jet80_noCut = new TH1F("hpp_Data_phi_Jet80_noCut","",50,-4,4);
  TH1F * hpp_Data_phi_Jet60_noCut = new TH1F("hpp_Data_phi_Jet60_noCut","",50,-4,4);
  TH1F * hpp_Data_phi_Jet40_noCut = new TH1F("hpp_Data_phi_Jet40_noCut","",50,-4,4);

  TH1F * hpp_Data_phi_Jet80_CutA = new TH1F("hpp_Data_phi_Jet80_CutA","",50,-4,4);
  TH1F * hpp_Data_phi_Jet60_CutA = new TH1F("hpp_Data_phi_Jet60_CutA","",50,-4,4);
  TH1F * hpp_Data_phi_Jet40_CutA = new TH1F("hpp_Data_phi_Jet40_CutA","",50,-4,4);
  
  TH1F * hpp_MC_phi_Jet80_noCut = new TH1F("hpp_MC_phi_Jet80_noCut","",50,-4,4);
  TH1F * hpp_MC_phi_Jet60_noCut = new TH1F("hpp_MC_phi_Jet60_noCut","",50,-4,4);
  TH1F * hpp_MC_phi_Jet40_noCut = new TH1F("hpp_MC_phi_Jet40_noCut","",50,-4,4);

  TH1F * hpp_MC_phi_Jet80_CutA = new TH1F("hpp_MC_phi_Jet80_CutA","",50,-4,4);
  TH1F * hpp_MC_phi_Jet60_CutA = new TH1F("hpp_MC_phi_Jet60_CutA","",50,-4,4);
  TH1F * hpp_MC_phi_Jet40_CutA = new TH1F("hpp_MC_phi_Jet40_CutA","",50,-4,4);
  
  TH2F * hpp_Data_noCut_phi_eta = new TH2F("hData_noCut_phi_eta","",50,-2.5,2.5,50,-4,4);
  TH2F * hpp_Data_CutA_phi_eta = new TH2F("hData_CutA_phi_eta","",50,-2.5,2.5,50,-4,4);
...
TH2F * hpp_Data_Jet40_noCut_JetpTeta = new TH2F(Form("hpp_Data_Jet40_noCut_pTeta_R%d",radius),Form("Data Jet40 no cuts pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   
TH2F * hpp_Data_Jet40_CutA_JetpTeta = new TH2F(Form("hpp_Data_Jet40_CutA_pTeta_R%d",radius),Form("Data Jet40 Cut A pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   
TH2F * hpp_Data_Jet60_noCut_JetpTeta = new TH2F(Form("hpp_Data_Jet60_noCut_pTeta_R%d",radius),Form("Data Jet60 no cuts pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   
TH2F * hpp_Data_Jet60_CutA_JetpTeta = new TH2F(Form("hpp_Data_Jet60_CutA_pTeta_R%d",radius),Form("Data Jet60 Cut A pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   
TH2F * hpp_Data_Jet80_noCut_JetpTeta = new TH2F(Form("hpp_Data_Jet80_noCut_pTeta_R%d",radius),Form("Data Jet80 no cuts pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   
TH2F * hpp_Data_Jet80_CutA_JetpTeta = new TH2F(Form("hpp_Data_Jet80_CutA_pTeta_R%d",radius),Form("Data Jet80 Cut A pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   

TH2F * hpp_MC_Jet40_noCut_JetpTeta = new TH2F(Form("hpp_MC_Jet40_noCut_pTeta_R%d",radius),Form("MC Jet40 no cuts pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   
TH2F * hpp_MC_Jet40_CutA_JetpTeta = new TH2F(Form("hpp_MC_Jet40_CutA_pTeta_R%d",radius),Form("MC Jet40 Cut A pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   
TH2F * hpp_MC_Jet60_noCut_JetpTeta = new TH2F(Form("hpp_MC_Jet60_noCut_pTeta_R%d",radius),Form("MC Jet60 no cuts pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   
TH2F * hpp_MC_Jet60_CutA_JetpTeta = new TH2F(Form("hpp_MC_Jet60_CutA_pTeta_R%d",radius),Form("MC Jet60 Cut A pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   
TH2F * hpp_MC_Jet80_noCut_JetpTeta = new TH2F(Form("hpp_MC_Jet80_noCut_pTeta_R%d",radius),Form("MC Jet80 no cuts pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);   
TH2F * hpp_MC_Jet80_CutA_JetpTeta = new TH2F(Form("hpp_MC_Jet80_CutA_pTeta_R%d",radius),Form("MC Jet80 Cut A pT-eta R%d",radius),100,-2.5,2.5,1000,0,400);     
  
  //canvases
  TCanvas * cpp_Data_noCut_eta = new TCanvas("cData_noCut_eta","",1500,600);
  TCanvas * cpp_Data_CutA_eta = new TCanvas("cData_CutA_eta","",1500,600);
  TCanvas * cpp_MC_noCut_eta = new TCanvas("cMC_noCut_eta","",1500,600);
  TCanvas * cpp_MC_CutA_eta = new TCanvas("cMC_CutA_eta","",1500,600);
  
  TCanvas * cpp_Data_noCut_phi = new TCanvas("cData_noCut_phi","",1500,600);
  TCanvas * cpp_Data_CutA_phi = new TCanvas("cData_CutA_phi","",1500,600);
  TCanvas * cpp_MC_noCut_phi = new TCanvas("cMC_noCut_phi","",1500,600);
  TCanvas * cpp_MC_CutA_phi = new TCanvas("cMC_CutA_phi","",1500,600);
  
  TCanvas * cpp_MC_Data_noCut_eta = new TCanvas("cMC_Data_noCut_eta","",1500,600);
  TCanvas * cpp_MC_Data_CutA_eta = new TCanvas("cMC_Data_CutA_eta","",1500,600);
  
  TCanvas * cpp_MC_Data_noCut_phi = new TCanvas("cMC_Data_noCut_phi","",1500,600);
  TCanvas * cpp_MC_Data_CutA_phi = new TCanvas("cMC_Data_CutA_phi","",1500,600);

  TCanvas  * cpp_Data_pteta_noCut = new TCanvas(Form("hpp_Data_noCut_pTeta_R%d",radius),Form("hpp_Data_noCut_pTeta_R%d",radius),1500,600);
  TCanvas  * cpp_Data_pteta_CutA = new TCanvas(Form("hpp_Data_CutA_pTeta_R%d",radius),Form("hpp_Data_CutA_pTeta_R%d",radius),1500,600);
  TCanvas  * cpp_MC_pteta_noCut = new TCanvas(Form("hpp_MC_noCut_pTeta_R%d",radius),Form("hpp_MC_noCut_pTeta_R%d",radius),1500,600);
  TCanvas  * cpp_MC_pteta_CutA = new TCanvas(Form("hpp_MC_CutA_pTeta_R%d",radius),Form("hpp_MC_CutA_pTeta_R%d",radius),1500,600);
  
  //cpp_pteta_noCut[i] = new TCanvas(Form("hData_noCut_pTeta_R%d_cent%d",radius,i),Form("hData_noCut_pTeta_R%d_cent%d",radius,i),1500,600);
  //cpp_pteta_CutA[i] = new TCanvas(Form("hData_CutA_pTeta_R%d_cent%d",radius,i),Form("hData_CutA_pTeta_R%d_cent%d",radius,i),1500,600);
  
   //cpp_Data_pteta_noCut[i] = new TCanvas(Form("hData_noCut_pTeta_R%d",radius),Form("hData_noCut_pTeta_R%d",radius),1500,600);
   //cpp_Data_pteta_CutA[i] = new TCanvas(Form("hData_CutA_pTeta_R%d",radius),Form("hData_CutA_pTeta_R%d",radius),1500,600);
   //cpp_MC_pteta_noCut[i] = new TCanvas(Form("hMC_noCut_pTeta_R%d",radius),Form("hMC_noCut_pTeta_R%d",radius),1500,600);
   //cpp_MC_pteta_CutA[i] = new TCanvas(Form("hMC_CutA_pTeta_R%d%d",radius),Form("hMC_CutA_pTeta_R%d",radius),1500,600);
  ...
  for(long nentry = 0; nentry < entries; ++nentry ){
    ...
    if(jet40_1 == 1 && jet60_1==0 && jet80_1==0) {
	  ...
	  hpp_Data_eta_Jet40_noCut->Fill(pfeta_1, Jet40_prescl);
	  hpp_Data_phi_Jet40_noCut->Fill(pfphi_1, Jet40_prescl);
	  hpp_Data_Jet40_noCut_JetpTeta->Fill(pfeta_1,pfpt_1,Jet40_prescl);
	...
	hpp_Data_eta_Jet40_CutA->Fill(pfeta_1, Jet40_prescl);
	hpp_Data_phi_Jet40_CutA->Fill(pfphi_1, Jet40_prescl);
	hpp_Data_Jet40_CutA_JetpTeta->Fill(pfeta_1,pfpt_1,Jet40_prescl);
      }
    ...
    if(jet60_1 == 1 && jet80_1==0) {
	  ...
	  hpp_Data_eta_Jet60_noCut->Fill(pfeta_1);
	  hpp_Data_phi_Jet60_noCut->Fill(pfphi_1);
	  hpp_Data_Jet60_noCut_JetpTeta->Fill(pfeta_1,pfpt_1);
	  
      if(calopt_1/pfpt_1 > 0.5 && calopt_1/pfpt_1 <= 0.85 && eMax_1/Sumcand < ((Float_t)18/7 *(Float_t)calopt_1/pfpt_1 - (Float_t)9/7)){
	hData_Jet60_CutA->Fill(pfpt_1);
	hpp_TrgObj60->Fill(pfpt_1);
	hpp_Data_eta_Jet60_CutA->Fill(pfeta_1);
	hpp_Data_phi_Jet60_CutA->Fill(pfphi_1);
	hpp_Data_Jet60_CutA_JetpTeta->Fill(pfeta_1,pfpt_1);
      }
      if(calopt_1/pfpt_1 > 0.85) {
	hData_Jet60_CutA->Fill(pfpt_1);
	hpp_TrgObj60->Fill(pfpt_1);
    ...
    if(jet80_1 == 1) {
	  ...
	  hpp_Data_eta_Jet80_noCut->Fill(pfeta_1);
	  hpp_Data_phi_Jet80_noCut->Fill(pfphi_1);
	  hpp_Data_Jet80_noCut_JetpTeta->Fill(pfeta_1,pfpt_1);

      if(calopt_1/pfpt_1 > 0.5 && calopt_1/pfpt_1 <= 0.85 && eMax_1/Sumcand < ((Float_t)18/7 *(Float_t)calopt_1/pfpt_1 - (Float_t)9/7)) {
	hData_Jet80_CutA->Fill(pfpt_1);
	hpp_TrgObj80->Fill(pfpt_1);
	hpp_Data_eta_Jet80_CutA->Fill(pfeta_1);
	hpp_Data_phi_Jet80_CutA->Fill(pfphi_1);
	hpp_Data_Jet80_CutA_JetpTeta->Fill(pfeta_1,pfpt_1);
      }
      if(calopt_1/pfpt_1 > 0.85){
	hData_Jet80_CutA->Fill(pfpt_1);
	hpp_TrgObj80->Fill(pfpt_1);
  ...
  for(long nentry = 0; nentry < entries; ++nentry){
    ...
    if(jet40_2 == 1 && jet60_2==0 && jet80_2 == 0){
	  ...
	  hpp_MC_eta_Jet40_noCut->Fill(pfeta_2, weight);
	  hpp_MC_phi_Jet40_noCut->Fill(pfphi_2, weight);
	  hpp_MC_Jet40_noCut_JetpTeta->Fill(pfeta_2,pfpt_2, weight);
	...
	hpp_MC_eta_Jet40_CutA->Fill(pfeta_2, weight);
	hpp_MC_phi_Jet40_CutA->Fill(pfphi_2, weight);
	hpp_MC_Jet40_CutA_JetpTeta->Fill(pfeta_2,pfpt_2, weight);
    ...
    if(jet60_2 == 1 && jet80_2 == 0){
	  ...
	  hpp_MC_eta_Jet60_noCut->Fill(pfeta_2, weight);
	  hpp_MC_phi_Jet60_noCut->Fill(pfphi_2, weight);
	  hpp_MC_Jet60_noCut_JetpTeta->Fill(pfeta_2,pfpt_2, weight);
	...
	hpp_matrix_HLT->Fill(pfrefpt_2, pfpt_2, weight);
	hpp_MC_eta_Jet60_CutA->Fill(pfeta_2, weight);
	hpp_MC_phi_Jet60_CutA->Fill(pfphi_2, weight);
	hpp_MC_Jet60_CutA_JetpTeta->Fill(pfeta_2,pfpt_2, weight);
    ...
    if(jet80_2 == 1){
	  ...
	  hpp_MC_eta_Jet80_noCut->Fill(pfeta_2, weight);
	  hpp_MC_phi_Jet80_noCut->Fill(pfphi_2, weight);
	  hpp_MC_Jet80_noCut_JetpTeta->Fill(pfeta_2,pfpt_2, weight);
	...
	hpp_matrix_HLT->Fill(pfrefpt_2, pfpt_2, weight);
	hpp_MC_eta_Jet80_CutA->Fill(pfeta_2, weight);
	hpp_MC_phi_Jet80_CutA->Fill(pfphi_2, weight);
	hpp_MC_Jet80_CutA_JetpTeta->Fill(pfeta_2,pfpt_2, weight);
...
/*for (int i = 0;i<=trigger;i++){
	hpp_Data_eta_Jet[i]_nocut->SetMarkerColor(kRed);
	hpp_Data_eta_Jet[i]_nocut->SetMarkerStyle(20);
	cout<<"applied style"<<endl;
	}
 */
 
 //eta
 
  cpp_Data_noCut_eta->cd();
  cpp_Data_noCut_eta->Divide(3,1);
  cpp_Data_noCut_eta->cd(1);
  hpp_Data_eta_Jet40_noCut->Draw();
  cpp_Data_noCut_eta->cd(2);
  hpp_Data_eta_Jet60_noCut->Draw();
  cpp_Data_noCut_eta->cd(3);
  hpp_Data_eta_Jet80_noCut->Draw();
  cpp_Data_noCut_eta->SaveAs(Form("hpp_Data_noCut_eta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
  
  cpp_Data_CutA_eta->cd();
  cpp_Data_CutA_eta->Divide(3,1);
  cpp_Data_CutA_eta->cd(1);
  hpp_Data_eta_Jet40_CutA->Draw();
  cpp_Data_CutA_eta->cd(2);
  hpp_Data_eta_Jet60_CutA->Draw();
  cpp_Data_CutA_eta->cd(3);
  hpp_Data_eta_Jet80_CutA->Draw();
  cpp_Data_CutA_eta->SaveAs(Form("hpp_Data_CutA_eta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
  
  cpp_MC_noCut_eta->cd();
  cpp_MC_noCut_eta->Divide(3,1);
  cpp_MC_noCut_eta->cd(1);
  hpp_MC_eta_Jet40_noCut->Draw();
  cpp_MC_noCut_eta->cd(2);
  hpp_MC_eta_Jet60_noCut->Draw();
  cpp_MC_noCut_eta->cd(3);
  hpp_MC_eta_Jet80_noCut->Draw();
  cpp_MC_noCut_eta->SaveAs(Form("hpp_MC_noCut_eta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
  
  cpp_MC_CutA_eta->cd();
  cpp_MC_CutA_eta->Divide(3,1);
  cpp_MC_CutA_eta->cd(1);
  hpp_MC_eta_Jet40_CutA->Draw();
  cpp_MC_CutA_eta->cd(2);
  hpp_MC_eta_Jet60_CutA->Draw();
  cpp_MC_CutA_eta->cd(3);
  hpp_MC_eta_Jet80_CutA->Draw();
  cpp_MC_CutA_eta->SaveAs(Form("hpp_MC_CutA_eta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
  
  //phi
  
  cpp_Data_noCut_phi->cd();
  cpp_Data_noCut_phi->Divide(3,1);
  cpp_Data_noCut_phi->cd(1);
  hpp_Data_phi_Jet40_noCut->Draw();
  cpp_Data_noCut_phi->cd(2);
  hpp_Data_phi_Jet60_noCut->Draw();
  cpp_Data_noCut_phi->cd(3);
  hpp_Data_phi_Jet80_noCut->Draw();
  cpp_Data_noCut_phi->SaveAs(Form("hpp_Data_noCut_phi_R%d_n20_phi_p20.pdf",radius),"RECREATE");
  
  cpp_Data_CutA_phi->cd();
  cpp_Data_CutA_phi->Divide(3,1);
  cpp_Data_CutA_phi->cd(1);
  hpp_Data_phi_Jet40_CutA->Draw();
  cpp_Data_CutA_phi->cd(2);
  hpp_Data_phi_Jet60_CutA->Draw();
  cpp_Data_CutA_phi->cd(3);
  hpp_Data_phi_Jet80_CutA->Draw();
  cpp_Data_CutA_phi->SaveAs(Form("hpp_Data_CutA_phi_R%d_n20_phi_p20.pdf",radius),"RECREATE");
  
  cpp_MC_noCut_phi->cd();
  cpp_MC_noCut_phi->Divide(3,1);
  cpp_MC_noCut_phi->cd(1);
  hpp_MC_phi_Jet40_noCut->Draw();
  cpp_MC_noCut_phi->cd(2);
  hpp_MC_phi_Jet60_noCut->Draw();
  cpp_MC_noCut_phi->cd(3);
  hpp_MC_phi_Jet80_noCut->Draw();
  cpp_MC_noCut_phi->SaveAs(Form("hpp_MC_noCut_phi_R%d_n20_phi_p20.pdf",radius),"RECREATE");
  
  cpp_MC_CutA_phi->cd();
  cpp_MC_CutA_phi->Divide(3,1);
  cpp_MC_CutA_phi->cd(1);
  hpp_MC_phi_Jet40_CutA->Draw();
  cpp_MC_CutA_phi->cd(2);
  hpp_MC_phi_Jet60_CutA->Draw();
  cpp_MC_CutA_phi->cd(3);
  hpp_MC_phi_Jet80_CutA->Draw();
  cpp_MC_CutA_phi->SaveAs(Form("hpp_MC_CutA_phi_R%d_n20_phi_p20.pdf",radius),"RECREATE");
  
  //pteta
  
  
  cpp_Data_pteta_noCut->cd();
  cpp_Data_pteta_noCut->Divide(3,1);
  cpp_Data_pteta_noCut->cd(1)->SetLogz();
  hpp_Data_Jet40_noCut_JetpTeta->Draw("colz");
  cpp_Data_pteta_noCut->cd(2)->SetLogz();
  hpp_Data_Jet60_noCut_JetpTeta->Draw("colz");
  cpp_Data_pteta_noCut->cd(3)->SetLogz();
  hpp_Data_Jet80_noCut_JetpTeta->Draw("colz");
  cpp_Data_pteta_noCut->SaveAs(Form("hpp_Data_noCut_pteta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
  
  cpp_Data_pteta_CutA->cd();
  cpp_Data_pteta_CutA->Divide(3,1);
  cpp_Data_pteta_CutA->cd(1)->SetLogz();
  hpp_Data_Jet40_CutA_JetpTeta->Draw("colz");
  cpp_Data_pteta_CutA->cd(2)->SetLogz();
  hpp_Data_Jet60_CutA_JetpTeta->Draw("colz");
  cpp_Data_pteta_CutA->cd(3)->SetLogz();
  hpp_Data_Jet80_CutA_JetpTeta->Draw("colz");
  cpp_Data_pteta_CutA->SaveAs(Form("hpp_Data_CutA_pteta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
  
  cpp_MC_pteta_noCut->cd();
  cpp_MC_pteta_noCut->Divide(3,1);
  cpp_MC_pteta_noCut->cd(1)->SetLogz();
  hpp_MC_Jet40_noCut_JetpTeta->Draw("colz");
  cpp_MC_pteta_noCut->cd(2)->SetLogz();
  hpp_MC_Jet60_noCut_JetpTeta->Draw("colz");
  cpp_MC_pteta_noCut->cd(3)->SetLogz();
  hpp_MC_Jet80_noCut_JetpTeta->Draw("colz");
  cpp_MC_pteta_noCut->SaveAs(Form("hpp_MC_noCut_pteta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
  
  cpp_MC_pteta_CutA->cd();
  cpp_MC_pteta_CutA->Divide(3,1);
  cpp_MC_pteta_CutA->cd(1)->SetLogz();
  hpp_MC_Jet40_CutA_JetpTeta->Draw("colz");
  cpp_MC_pteta_CutA->cd(2)->SetLogz();
  hpp_MC_Jet60_CutA_JetpTeta->Draw("colz");
  cpp_MC_pteta_CutA->cd(3)->SetLogz();
  hpp_MC_Jet80_CutA_JetpTeta->Draw("colz");
  cpp_MC_pteta_CutA->SaveAs(Form("hpp_MC_CutA_pteta_R%d_n20_eta_p20.pdf",radius),"RECREATE");
  
  //overlaid MC/Data
  
  
  cpp_MC_Data_noCut_eta->cd();
  cpp_MC_Data_noCut_eta->Divide(3,1);
  cpp_MC_Data_noCut_eta->cd(1);
  hpp_Data_eta_Jet40_noCut->SetMarkerStyle(20);
  hpp_Data_eta_Jet40_noCut->SetMarkerColor(kBlack);
  hpp_Data_eta_Jet40_noCut->DrawNormalized();
  hpp_MC_eta_Jet40_noCut->SetMarkerStyle(24);
  hpp_MC_eta_Jet40_noCut->SetMarkerColor(kRed);
  hpp_MC_eta_Jet40_noCut->DrawNormalized("same");
  cpp_MC_Data_noCut_eta->cd(2);
  hpp_Data_eta_Jet60_noCut->SetMarkerStyle(20);
  hpp_Data_eta_Jet60_noCut->SetMarkerColor(kBlack);
  hpp_Data_eta_Jet60_noCut->DrawNormalized();
  hpp_MC_eta_Jet60_noCut->SetMarkerStyle(24);
  hpp_MC_eta_Jet60_noCut->SetMarkerColor(kRed);
  hpp_MC_eta_Jet60_noCut->DrawNormalized("same");  
  cpp_MC_Data_noCut_eta->cd(3);
  hpp_Data_eta_Jet80_noCut->SetMarkerColor(kBlack);
  hpp_Data_eta_Jet80_noCut->SetMarkerStyle(20);
  hpp_Data_eta_Jet80_noCut->DrawNormalized();
  hpp_MC_eta_Jet80_noCut->SetMarkerStyle(24);
  hpp_MC_eta_Jet80_noCut->SetMarkerColor(kRed);
  hpp_MC_eta_Jet80_noCut->DrawNormalized("same");
  cpp_MC_Data_noCut_eta->SaveAs(Form("hpp_MC_Data_noCut_eta_R%d_n20_eta_p20.pdf",radius),"RECREATE");

  cpp_MC_Data_CutA_eta->cd();
  cpp_MC_Data_CutA_eta->Divide(3,1);
  cpp_MC_Data_CutA_eta->cd(1);
  hpp_Data_eta_Jet40_CutA->SetMarkerStyle(20);
  hpp_Data_eta_Jet40_CutA->SetMarkerColor(kBlack);
  hpp_Data_eta_Jet40_CutA->DrawNormalized();
  hpp_MC_eta_Jet40_CutA->SetMarkerStyle(24);
  hpp_MC_eta_Jet40_CutA->SetMarkerColor(kRed);
  hpp_MC_eta_Jet40_CutA->DrawNormalized("same");
  cpp_MC_Data_CutA_eta->cd(2);
  hpp_Data_eta_Jet60_CutA->SetMarkerStyle(20);
  hpp_Data_eta_Jet60_CutA->SetMarkerColor(kBlack);
  hpp_Data_eta_Jet60_CutA->DrawNormalized();
  hpp_MC_eta_Jet60_CutA->SetMarkerStyle(24);
  hpp_MC_eta_Jet60_CutA->SetMarkerColor(kRed);
  hpp_MC_eta_Jet60_CutA->DrawNormalized("same");  
  cpp_MC_Data_CutA_eta->cd(3);
  hpp_Data_eta_Jet80_CutA->SetMarkerColor(kBlack);
  hpp_Data_eta_Jet80_CutA->SetMarkerStyle(20);
  hpp_Data_eta_Jet80_CutA->DrawNormalized();
  hpp_MC_eta_Jet80_CutA->SetMarkerStyle(24);
  hpp_MC_eta_Jet80_CutA->SetMarkerColor(kRed);
  hpp_MC_eta_Jet80_CutA->DrawNormalized("same");
  cpp_MC_Data_CutA_eta->SaveAs(Form("hpp_MC_Data_CutA_eta_R%d_n20_eta_p20.pdf",radius),"RECREATE");

  cpp_MC_Data_noCut_phi->cd();
  cpp_MC_Data_noCut_phi->Divide(3,1);
  cpp_MC_Data_noCut_phi->cd(1);
  hpp_Data_phi_Jet40_noCut->SetMarkerStyle(20);
  hpp_Data_phi_Jet40_noCut->SetMarkerColor(kBlack);
  hpp_Data_phi_Jet40_noCut->DrawNormalized();
  hpp_MC_phi_Jet40_noCut->SetMarkerStyle(24);
  hpp_MC_phi_Jet40_noCut->SetMarkerColor(kRed);
  hpp_MC_phi_Jet40_noCut->DrawNormalized("same");
  cpp_MC_Data_noCut_phi->cd(2);
  hpp_Data_phi_Jet60_noCut->SetMarkerStyle(20);
  hpp_Data_phi_Jet60_noCut->SetMarkerColor(kBlack);
  hpp_Data_phi_Jet60_noCut->DrawNormalized();
  hpp_MC_phi_Jet60_noCut->SetMarkerStyle(24);
  hpp_MC_phi_Jet60_noCut->SetMarkerColor(kRed);
  hpp_MC_phi_Jet60_noCut->DrawNormalized("same");  
  cpp_MC_Data_noCut_phi->cd(3);
  hpp_Data_phi_Jet80_noCut->SetMarkerColor(kBlack);
  hpp_Data_phi_Jet80_noCut->SetMarkerStyle(20);
  hpp_Data_phi_Jet80_noCut->DrawNormalized();
  hpp_MC_phi_Jet80_noCut->SetMarkerStyle(24);
  hpp_MC_phi_Jet80_noCut->SetMarkerColor(kRed);
  hpp_MC_phi_Jet80_noCut->DrawNormalized("same");
  cpp_MC_Data_noCut_phi->SaveAs(Form("hpp_MC_Data_noCut_phi_R%d_n20_eta_p20.pdf",radius),"RECREATE");
  
  cpp_MC_Data_CutA_phi->cd();
  cpp_MC_Data_CutA_phi->Divide(3,1);
  cpp_MC_Data_CutA_phi->cd(1);
  hpp_Data_phi_Jet40_CutA->SetMarkerStyle(20);
  hpp_Data_phi_Jet40_CutA->SetMarkerColor(kBlack);
  hpp_Data_phi_Jet40_CutA->DrawNormalized();
  hpp_MC_phi_Jet40_CutA->SetMarkerStyle(24);
  hpp_MC_phi_Jet40_CutA->SetMarkerColor(kRed);
  hpp_MC_phi_Jet40_CutA->DrawNormalized("same");
  cpp_MC_Data_CutA_phi->cd(2);
  hpp_Data_phi_Jet60_CutA->SetMarkerStyle(24);
  hpp_Data_phi_Jet60_CutA->SetMarkerColor(kBlack);
  hpp_Data_phi_Jet60_CutA->DrawNormalized();
  hpp_MC_phi_Jet60_CutA->SetMarkerStyle(24);
  hpp_MC_phi_Jet60_CutA->SetMarkerColor(kRed);
  hpp_MC_phi_Jet60_CutA->DrawNormalized("same");  
  cpp_MC_Data_CutA_phi->cd(3);
  hpp_Data_phi_Jet80_CutA->SetMarkerColor(kBlack);
  hpp_Data_phi_Jet80_CutA->SetMarkerStyle(20);
  hpp_Data_phi_Jet80_CutA->DrawNormalized();
  hpp_MC_phi_Jet80_CutA->SetMarkerStyle(24);
  hpp_MC_phi_Jet80_CutA->SetMarkerColor(kRed);
  hpp_MC_phi_Jet80_CutA->DrawNormalized("same");
  cpp_MC_Data_CutA_phi->SaveAs(Form("hpp_MC_Data_CutA_phi_R%d_n20_eta_p20.pdf",radius),"RECREATE");
